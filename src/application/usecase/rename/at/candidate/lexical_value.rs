...
use super::Candidate;
use crate::application::usecase::rename::{binding_rename_parts, selection::apply_byte_span_edits};
use crate::domain::dialect::Dialect;
use crate::domain::sexpr::{Path, SymbolName, SyntaxTree};

pub(in crate::application::usecase::rename::at) fn binding_candidates(
    tree: &SyntaxTree,
    input: &str,
    path: &Path,
    from: &SymbolName,
