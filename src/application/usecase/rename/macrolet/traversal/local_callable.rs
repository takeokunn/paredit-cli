...
pub(in crate::application::usecase::rename::macrolet) enum LocalCallableTraversal {
    Handled,
    DefinitionBody(Option<DefinitionBodyRange>),
}

pub(in crate::application::usecase::rename::macrolet) fn collect_local_callable_or_definition<
