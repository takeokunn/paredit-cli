...
use crate::application::usecase::function_parameter::definition::FunctionParameterDefinitionScope;
...
pub(in crate::application::usecase::function_parameter) struct FunctionCallPathRequest<'a> {
    pub(in crate::application::usecase::function_parameter) tree: &'a SyntaxTree,
    pub(in crate::application::usecase::function_parameter) dialect: Dialect,
    pub(in crate::application::usecase::function_parameter) explicit_call_paths: Vec<Path>,
    pub(in crate::application::usecase::function_parameter) all_calls: bool,
    pub(in crate::application::usecase::function_parameter) definition_span: ByteSpan,
    pub(in crate::application::usecase::function_parameter) definition_scope:
        FunctionParameterDefinitionScope,
    pub(in crate::application::usecase::function_parameter) function_name: &'a SymbolName,
    pub(in crate::application::usecase::function_parameter) command: &'a str,
}
...
fn validate_explicit_function_call_paths(
    ...
    for call_path in explicit_call_paths {
        ...
        if !super::matches_function_call_view(&view, function_name) {
            let Some(head) =
                crate::application::usecase::function_parameter::list_edit::list_head(&view)
            else {
                anyhow::bail!("{command} --call-path {call_path} must select a function call list");
            };
            anyhow::bail!(
