...
pub(in crate::application::usecase::function_parameter) struct FunctionCallView<'a> {
    pub(in crate::application::usecase::function_parameter) view: &'a ExpressionView,
    pub(in crate::application::usecase::function_parameter) argument_offset: usize,
}

pub(in crate::application::usecase::function_parameter) fn resolve_function_call_view<'a>(
