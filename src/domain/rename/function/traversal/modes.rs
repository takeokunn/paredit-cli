...
pub(in crate::domain::rename::function) fn collect_local_callable_function_call_renames(
    view: &ExpressionView,
    head: &str,
...
pub(in crate::domain::rename::function) fn collect_symbol_macrolet_function_call_renames(
    view: &ExpressionView,
    head: &str,
    context: &TraversalContext<'_>,
    state: TraversalState<'_>,
