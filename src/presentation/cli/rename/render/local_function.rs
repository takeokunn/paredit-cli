...
use super::super::types::RenameLocalFunctionFileReport;
use super::shared::rename_occurrences_json;
use crate::domain::sexpr::SymbolName;

pub(in crate::presentation::cli::rename) fn print_rename_local_function_report(
    reports: &[RenameLocalFunctionFileReport],
    from: &SymbolName,
    to: &SymbolName,
    write: bool,
    output: OutputFormat,
